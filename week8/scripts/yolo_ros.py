...
from week8.srv import YOLOLastFrame, YOLOLastFrameResponse
from week8.msg import YOLODetection
import numpy as np
...
class YOLOv4ROSITR:
    def __init__(self):
        self.detector = Detector(gpu_id=0, config_path='/opt/darknet/cfg/yolov4.cfg',
                                 ...
                                 meta_path='/home/YOUR_USERNAME/ITR/src/week8/config/coco.data')
